...
const CategoryItem = ({ imageUrl, url, title, alt }: CategoryItemProps) => {
  return (
    <Link href={url}>
      <div className="w-[240px] h-[160px] relative rounded overflow-hidden group">
        <Image src={imageUrl} alt={alt} width={240} height={160} className="object-cover bg-contain w-hull h-full" />
