...
const CategoryItem = ({ imageUrl, url, title, alt }: CategoryItemProps) => {
  return (
    <Link href={url}>
      <div className="h-[240px] w-[160px] relative rounded overflow-hidden group">
        <Image src={imageUrl} alt={alt} height={240} width={160} className="object-cover bg-contain w-hull h-full" />
